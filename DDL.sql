...
CREATE TABLE `posts_post` (
  ...
  `user_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `posts_post_user_id_a4f40dc7_fk_users_user_id` (`user_id`),
  CONSTRAINT `posts_post_user_id_a4f40dc7_fk_users_user_id` FOREIGN KEY (`user_id`) REFERENCES `users_user` (`id`)
